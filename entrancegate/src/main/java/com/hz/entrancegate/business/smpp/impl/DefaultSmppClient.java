package com.hz.entrancegate.business.smpp.impl;
...
import com.hz.entrancegate.business.smpp.channel.*;
...
public class DefaultSmppClient implements SmppClient {
	...
	public BaseBind createBindRequest(SmppSessionConfiguration config) throws UnrecoverablePduException {
		BaseBind bind = null;
