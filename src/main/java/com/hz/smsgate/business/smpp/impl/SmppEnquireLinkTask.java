...
class SmppEnquireLinkTask implements Runnable {

	private static final Logger logger = LoggerFactory.getLogger(SmppEnquireLinkTask.class);
	private SmppClient client;
	private Integer enquireLinkTimeout;

	public SmppEnquireLinkTask(SmppClient client, Integer enquireLinkTimeout) {
		this.client = client;
