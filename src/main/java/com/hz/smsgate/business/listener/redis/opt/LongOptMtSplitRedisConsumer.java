 ...
 */
@Component
public class LongOptMtSplitRedisConsumer implements Runnable {
	private static Logger LOGGER = LoggerFactory.getLogger(LongOptMtSplitRedisConsumer.class);


	@Autowired
	public RedisUtil redisUtil;

	public static LongOptMtSplitRedisConsumer longMtSplitRedisConsumer;
		...
		while (true) {
			...
			try {
				if (longMtSplitRedisConsumer.redisUtil != null) {
					Object obj = longMtSplitRedisConsumer.redisUtil.rPop(SmppServerConstants.WEB_LONG_SUBMIT_SM_SEND_OPT);
					if (obj != null) {
