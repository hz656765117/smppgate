                ...
                if (longRealMtSendRedisConsumer.redisUtil != null) {
                    ...
                    if (obj != null) {
                        ...
                        for (String key : tempMsgIds) {
                            longRealMtSendRedisConsumer.redisUtil.hmRemove(SmppServerConstants.WEB_MSGID_CACHE, key);
                            longRealMtSendRedisConsumer.redisUtil.hmSet(SmppServerConstants.WEB_MSGID_CACHE, messageId, key);
                        }
                    } else {
